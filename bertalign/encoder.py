...
class Encoder:
    ...
    def transform(self, sents, num_overlaps: int):
        """Transform incominig sentences using model.

        Args:
            sents: sentences.
            num_overlaps: see max_align in Aligner class.

        Returns:
           Tuple containing sentence embeddings and their lengths.
